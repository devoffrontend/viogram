  ...
  return (
    <section className="pb-20 lg:pb-32 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="gap-8 mx-auto w-full flex">
          {/* Problem Card */}
          <Card className="bg-[#F4F1EB] rounded-lg">
            <CardContent className="px-10 py-8 flex gap-6">
              <Image
              ...
              <div className="flex-col flex items-start gap-4 flex-1">
                <h3 className="text-2xl font-bold text-neutral-900 uppercase">Problem</h3>
          ...
          {/* Solution Card */}
          <Card className="bg-gradient-to-br  from-neutral-900 via-neutral-800  to-amber-900 rounded-lg">
            <CardContent className="px-10 py-8 flex gap-6">
              <Image
                ...
                height={90}
              />
              <div className="flex-col items-start gap-4 mb-4 flex-1">
                <h3 className="text-2xl font-bold text-white uppercase">SOLUTION</h3>
